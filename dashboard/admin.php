...
<section class="page-banner">
    <section class="container">
        ...
        <p>Signed in as <strong><?= e($user['full_name']) ?></strong>
           (<?= e($user['email']) ?>) &middot; role: admin</p>
    </section>
</section>
...
<div class="container dash">
    ...
    <section class="dash-section" aria-labelledby="people-heading">
        ...
        <dl class="dash-stat-grid">
            <div class="dash-stat"><dt>Patients</dt><dd><?= (int) $roleCounts['patient'] ?></dd></div>
            <div class="dash-stat"><dt>Doctors</dt><dd><?= (int) $roleCounts['doctor'] ?></dd></div>
            <div class="dash-stat"><dt>Administrators</dt><dd><?= (int) $roleCounts['admin'] ?></dd></div>
            <div class="dash-stat"><dt>Departments</dt><dd><?= (int) $deptCount ?></dd></div>
            <div class="dash-stat">
    ...
    <section class="dash-section" aria-labelledby="appt-heading">
        <h2 id="appt-heading">Appointments</h2>
        <dl class="dash-stat-grid">
            <div class="dash-stat"><dt>Total</dt><dd><?= (int) $appointmentsTotal ?></dd></div>
            <div class="dash-stat"><dt>Pending</dt><dd><?= (int) $statusCounts['pending'] ?></dd></div>
            <div class="dash-stat"><dt>Confirmed</dt><dd><?= (int) $statusCounts['confirmed'] ?></dd></div>
            <div class="dash-stat"><dt>Completed</dt><dd><?= (int) $statusCounts['completed'] ?></dd></div>
            <div class="dash-stat"><dt>Cancelled</dt><dd><?= (int) $statusCounts['cancelled'] ?></dd></div>
            <div class="dash-stat"><dt>Scheduled today</dt><dd><?= (int) $todayCount ?></dd></div>
        </dl>
    </section>
    ...
    <div class="dash-subgrid dash-subgrid--2">
        <section class="dash-section" aria-labelledby="reg-heading">
            <h2 id="reg-heading">Latest patient registrations</h2>
                    ...
                    <table class="dash-table">
                        ...
                        <tbody>
                            <?php foreach ($registrations as $r): ?>
                                <tr>
                                    <th scope="row"><?= e(fmt_datetime($r['created_at'])) ?></th>
                                    <td><?= e($r['full_name']) ?></td>
                                    <td><?= e($r['email']) ?></td>
                                </tr>
                            <?php endforeach; ?>
        ...
        <section class="dash-section" aria-labelledby="chg-heading">
            <h2 id="chg-heading">Recent appointment changes</h2>
